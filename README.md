...
* [Useberry](https://www.useberry.com/) —A usability testing tool that allows importing prototypes from InVision, AdodeXD, Sketch, and Marvel, choosing among 5 different test types and getting users’ behavior insights with heatmaps, video recordings, user flows, time bars and answers to 3 types of follow-up questions.
