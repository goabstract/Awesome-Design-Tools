...
- [Screenstab](https://screenstab.com) — one-click tool to magically create marketing assets from simple screenshots. ![web](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/web.svg)
