...
* [Akira](https://github.com/akiraux/Akira) - native Linux App for UI and UX Design built in Vala and Gtk with focus on offering a modern and fast approach to UI and UX Design, mainly targeting web designers and graphic designers. ![open-source.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/open-source.svg)
