...
- [ScreenApp](https://screenapp.io/#/) — web browser based lighweight screen recorder which can record either a tab or full screen for free. It also gives storage space to store all the screen recordings. ![free.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/free.svg)
